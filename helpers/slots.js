 ...
 */
/**
 * Gets constant time from Tops epoch.
...
/**
 * Calculates time since Tops epoch.
 * @param {number|undefined} time - Time in unix seconds.
 * @returns {number} current time - tops epoch time.
 */
...
module.exports = {
	 ...
	 * @method
	 * @param {number} time
	 * @return {number} tops epoch time constant.
	 */
	 ...
	 * @return {number} constant time from Tops epoch + input time.
	 */
